...
/* para usar el formato de fecha y hora de nuestra zona horaria */
use Carbon\Carbon;
use Response;
...
class IngresoController extends Controller
{
    ...
    {
    	/* utilizamos un capturador de excepciones*/
    	try{
    		/* utilizamos un validador de transaccion por si hay error al momento de guardar la informacion*/
    		DB::beginTransaction();
    		$ingreso=new Ingreso;
