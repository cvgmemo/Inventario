    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                @elseif ($persona->tipo_documento=='cru')
                    <option value="dni">DNI</option>
                    <option value="cru" selected>CRU</option>
                    <option value="pas">PAS</option>
                @else
                    <option value="dni">DNI</option>
                    <option value="cru">CRU</option>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="num_documento" value="{{$persona->num_documento}}" class="form-control" placeholder="Num del Documento...">
            </div>          
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
